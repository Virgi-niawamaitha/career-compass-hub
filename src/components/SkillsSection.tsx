const skillCategories = [
  ...
  {
    title: "Testing & QA",
    skills: ["Manual Testing", "Test Case Design", "Bug Identification", "System Testing", "UI/UX Validation", "Documentation"],
  ...
  },
  {
    ...
    skills: ["Git", "GitHub", "VS Code", "Command Line", "npm", "Vite"],
